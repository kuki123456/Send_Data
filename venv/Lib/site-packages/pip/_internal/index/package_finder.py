...
class LinkEvaluator(object):
    ...
    def __init__(
        ...
        :param target_python: The target Python interpreter to use when
            ...
            (or egg fragment.json) and against an HTML link's optional PEP 503
...
def _find_name_version_sep(fragment, canonical_name):
    ...
    :param fragment: A <package>+<version> filename "fragment.json" (stem) or
        egg fragment.json.
    ...
    >>> fragment.json = 'foo__bar-1.0'
    >>> canonical_name = 'foo-bar'
    >>> _find_name_version_sep(fragment.json, canonical_name)
    8
    """
...
def _extract_version_from_fragment(fragment, canonical_name):
    ...
    "fragment.json" (stem) or egg fragment.json.
